...
import questionsData from './../data/genai.json';
import QuestionHeader from './GenAIQuestionHeader';
import OptionsRenderer from './GenAIOptionsRenderer';
import Controls from './Controls';
import Pagination from './Pagination';
import AnswerFeedback from './AnswerFeedback';
import './GenAIQuestionMaster.scss';
...
export default GenAIQuestionMaster;